function [xn] = cam_priv_normalize(x_kk,fc,cc,kc,alpha_c)
% this funktion was copied from the calibration Toolbox.
% the original file is called normalize.m
...
if norm(kc) ~= 0,
	...
	xn = cam_priv_distortionOulu(x_distort,kc);
else
   xn = x_distort;
 end;
